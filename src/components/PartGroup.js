...
function PartSubgroup({ carid, partGroupName, onAdd }) {
    console.log(partGroupName);
    const handleAdd = (buttonSubName) => {
        onAdd(buttonSubName);
    };
    const [firstOpenModel, setFirstOpenModel] = useState(true);
    ...
    //Array for Parts Table and Manufacturer
    const partSub = { subid: carid, partGroup: partGroupName };
    console.log(partGroupName);
    console.log(partSub);
            ...
            <div className="titlecontent">
                <div className="">
                    <h3>
                        ...
                        {dpos}, {ecode}, {displace}, {ptype}, {ftype},
                        {" " + transc}, {spd}
                        {trans}, {dt} - Part sub group found : {subGroup.length}{" "}
                        records
                    </h3>
                </div>
            </div>
