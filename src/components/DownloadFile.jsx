...
function DownloadVListFile (fileData, fileName, sheetName, fileExType) {
    /*  
    Imported Variable Guide:
        - fileData = JSON Data imported from where function is called (preferably direct exported from Database Fetching)
        - fileName = Your wished file name to export
    ...
    */
    ...
    if (fileExType==="csv") {
        ...
        let loc = backlocale+"down/downvehicle";
        fetch(loc, {
            method: "POST",
            credentials: "include",
            headers: {
...
function DownloadPRListFile (fileData, fileName, sheetName, fileExType) {
    /*  
    Imported Variable Guide:
        - fileData = JSON Data imported from where function is called (preferably direct exported from Database Fetching)
        - fileName = Your wished file name to export
    ...
    */
    ...
    if (fileExType==="csv") {
        ...
        let loc = backlocale+"down/downresultpart";
        fetch(loc, {
            method: "POST",
            credentials: "include",
            headers: {
...
function DownloadRListFile (fileData, fileName, sheetName, fileExType) {
    /*  
    Imported Variable Guide:
        - fileData = JSON Data imported from where function is called (preferably direct exported from Database Fetching)
        - fileName = Your wished file name to export
    ...
    */
    ...
    if (fileExType==="csv") {
        ...
        let loc = backlocale+"down/downresultlist";
        fetch(loc, {
            method: "POST",
            credentials: "include",
            headers: {
...
export {DownloadPListFile, DownloadVListFile, DownloadPRListFile, DownloadRListFile}
